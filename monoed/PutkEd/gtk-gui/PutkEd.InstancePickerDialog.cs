...
namespace PutkEd
{
	public partial class InstancePickerDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget PutkEd.InstancePickerDialog
			this.Name = "PutkEd.InstancePickerDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child PutkEd.InstancePickerDialog.VBox
			...
			this.m_assets = new global::Gtk.TreeView ();
			this.m_assets.CanFocus = true;
			this.m_assets.Name = "m_assets";
			this.GtkScrolledWindow.Add (this.m_assets);
			w1.Add (this.GtkScrolledWindow);
			global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(w1 [this.GtkScrolledWindow]));
			w3.Position = 0;
			// Internal child PutkEd.InstancePickerDialog.ActionArea
			...
			this.Show ();
			this.m_assets.RowActivated += new global::Gtk.RowActivatedHandler (this.OnRowActivated);
