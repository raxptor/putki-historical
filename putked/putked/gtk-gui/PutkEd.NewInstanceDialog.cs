...
namespace PutkEd
{
	public partial class NewInstanceDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget PutkEd.NewInstanceDialog
			this.Name = "PutkEd.NewInstanceDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child PutkEd.NewInstanceDialog.VBox
			...
			w1.Add (this.m_types);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(w1 [this.m_types]));
			w2.Position = 0;
			w2.Expand = false;
			w2.Fill = false;
			// Internal child PutkEd.NewInstanceDialog.ActionArea
